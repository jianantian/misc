...
\verb"    \usepackage[rightcaption,raggedright]{sidecap}% for side captions"\\
\verb"    \usepackage{framed} % for floatingboxes"\\
\verb"    \usepackage{soul}   % for letterspacing in theorem-style headings"\\
\verb"    \usepackage[agsm]{harvard}"\\
...
The typefaces for the final typeset version of the \cambridge\ design are Times for the text, and Adobe Helvetica Neue Condensed for the sans-serif elements, such as headings.
...
\subsection{Adobe Helvetica Neue Condensed}
...
\end{verbatim}
This command will call in helvneue.sty, which is distributed with this package.
