...
Finally, run your book through \LaTeX\ twice again. This series of runs will generate a file called {\verbatimsize\texttt{\cambridge guide.bbl}}, which will then be included by \verb"\bibliography{percolation}".
